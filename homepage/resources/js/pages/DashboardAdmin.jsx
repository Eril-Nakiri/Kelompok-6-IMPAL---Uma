    ...
    <main className="db-main">
        ...
        <div className="db-body">
            <div className="stats-grid">
                ...
                <div className="stat-value">
                    {stats.activeMatches}
                    <span className="stat-badge badge-pulse">🎮 Live Now</span>
                </div>
                </div>
                <div className="stat-card">
            ...
            <div className="panel-grid">
                ...
                <div className="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colSpan="5" style={{ textAlign: 'center', color: '#64748B', padding: '24px 0' }}>Tidak ada pertandingan aktif saat ini.</td>
                        </tr>
                        ) : (
                        recentMatches.map((match) => (
                            ...
                            <td>
                                ...
                                {match.nama_tim_a || 'Team A'} <span className="match-vs">vs</span> {match.nama_tim_b || 'Team B'}
                                </div>
                            ...
                            <td style={{ textAlign: 'center' }} className="match-score">
                                {match.skor_akhir_a ?? 0} - {match.skor_akhir_b ?? 0}
                            </td>
                            <td>
                                <span className="status-pill status-ongoing">Active</span>
                            </td>
                ...
                <div className="info-box">
                    💡 Seluruh aksi input terekam langsung di Database PostgreSQL Anda.
                </div>
                </div>
            </div>
        </div>
